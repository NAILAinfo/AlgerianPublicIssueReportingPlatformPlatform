...
export function AdminDashboard({ currentUser }: AdminDashboardProps) {
  ...
  const updateReportStatus = async (reportId: string, newStatus: 'new' | 'in-progress' | 'resolved') => {
    try {
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge variant="outline" className={getPriorityColor(report.priority)}>
                            {priorityNames[report.priority as keyof typeof priorityNames]}
                          </Badge>
                        </div>
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <Badge variant="secondary">{issueNames[report.type as keyof typeof issueNames]}</Badge>
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <Select
                        value={report.status}
                        onValueChange={(value) => updateReportStatus(report.id, value as 'new' | 'in-progress' | 'resolved')}
                      >
